...
test.describe("Test touch input handler", () => {
  ...
  test("When two touches are started simultaneously, it should be treated as a middle mouse button click", async ({
    page,
  }) => {
    page.on("console", (msg) => console.log(msg.text()));
    const [inputControl, window, document, target] = initInputControl();
    const eventStart = initTouchEvent(
      window,
      "touchstart",
      target,
      [],
  ...
  test("Touchmove event with a single touch", async ({ page }) => {
    ...
    const touchStart = initTouchEvent(
      window,
      "touchstart",
      target,
      downTouches,
    ...
    const touchMove = initTouchEvent(
      window,
      "touchmove",
      target,
      moveTouches,
  ...
  test("Touchmove event with multiple simultaneous touches", async ({
    page,
  }) => {
    const [inputControl, window, document, target] = initInputControl();
    const downTouches = [
    ...
    const eventDown = initTouchEvent(
      window,
      "touchstart",
      target,
      downTouches,
    ...
    const eventMove = initTouchEvent(
      window,
      "touchmove",
      target,
      moveTouches,
  ...
  test("Touchmove event for pan and pinch zoom", async ({ page }) => {
    ...
    const touchMove_0 = initTouchEvent(
      window,
      "touchmove",
      target,
      moveTouches_0,
    ...
    const touchMove_1 = initTouchEvent(
      window,
      "touchmove",
      target,
      moveTouches_1,
